...
public class RMS_Clone_CSR extends javax.swing.JFrame {
   ...
   String login_msg = rms.clone.main.business.actions.login(Integer.toString(profileId), autoPassword);
    ...
    private void initComponents() {
        ...
        pay_bill_bttn = new javax.swing.JButton();
        ...
        pay_bill_bttn.setText("Pay Bill");
        pay_bill_bttn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pay_bill_bttnActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(pay_bill_bttn)
                .addGap(3, 3, 3)
                .addComponent(new_bttn)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(new_sale_bttn, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(pay_bill_bttn, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jMenuItem7.setText("Employee Managment");
        ...
        jMenuItem11.setText("Contractor Managment");
        jMenu5.add(jMenuItem11);

        jMenuItem8.setText("Discount Managment");
...
new send_feedback_agent().setVisible(true);
    ...
    private void pay_bill_bttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pay_bill_bttnActionPerformed
        ...
        System.out.println("Acct Number:" + vars.selectedCx.getAccountNumber());
         try {
        String SQL =
            "SELECT COALESCE(SUM(total_amount_due), 0) AS total_amount_due " +
            "FROM phone_bills " +
            "WHERE account_number = ? AND is_paid = 0";

        // Make sure selectedCx is not null before querying
        ...
        try (PreparedStatement ps = vars.conn.prepareStatement(SQL)) {
            ps.setString(1, vars.selectedCx.getAccountNumber());

            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    double due = rs.getDouble("total_amount_due");
                    System.out.println("SUM due = " + due);
                    pay_bill.ammtDue = due;
                    String billPayID = generateConfNumber("Bill Pay");
                    pay_bill.BillPayID = billPayID;
                    orderNumber_txt.setText(billPayID);
                }
            }
        }
...
public static void checkIfLoggedIn() {
    if (!vars.isLoggedIn) {
        ...
        pay_bill_bttn.setEnabled(false);
...
public static String generateConfNumber(String transactionType) {
   ...
   long min; // Smallest 10-digit number
    ...
    else if ("Bill Pay".equals(transactionType)) {
//    try {
//        String SQL =
//            "SELECT COALESCE(SUM(total_amount_due), 0) AS total_amount_due " +
//            "FROM phone_bills " +
...
//            return null; // or "OT" + randomNumber, depending on your flow
//        }
//
//        try (PreparedStatement ps = vars.conn.prepareStatement(SQL)) {
//            ps.setString(1, vars.selectedCx.getAccountNumber());
